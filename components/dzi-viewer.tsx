        ...
        const initViewer = async () => {
            ...
            try {
                ...
                const viewerInstance = OpenSeadragon({
                    ...
                    showNavigator: true,
                    navigatorPosition: "BOTTOM_LEFT", // moved built-in navigator to bottom-left to match our custom minimap position
        ...
        <div ref={containerRef} className="relative h-full w-full">
            ...
            {!isLoading && (
                <motion.div
                    ...
                    transition={{ delay: 1 }}
                    className="pointer-events-none absolute bottom-4 left-64 z-10 max-w-xs rounded-lg border border-primary/50 bg-background/80 px-4 py-2 backdrop-blur-sm" // moved instructions to left side to avoid overlap with minimap
                >
