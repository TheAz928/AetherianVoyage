    ...
    const featuredImages = [
        {
            ...
            thumbnail:
                universeData[0].solarSystems[0].planets[0].images[0].thumbnail,
        ...
        },
        {
            ...
            thumbnail:
                universeData[0].solarSystems[0].planets[1].images[0].thumbnail,
        ...
        },
        {
            ...
            thumbnail:
                universeData[0].solarSystems[0].planets[2].images[0].thumbnail,
            ...
            <main className="relative flex min-h-screen flex-col items-center justify-center px-4 pt-32 transform-gpu">
                ...
                >
                    ...
                    >
                        ...
                        . Discover Earth, Moon, Mars, and distant galaxies in
                ...
                <div className="mt-32 w-full max-w-6xl pb-20">
                    ...
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 transform-gpu">
                        {universeData.map((galaxy, index) => {
                            const totalPlanets = galaxy.solarSystems.reduce(
                            ...
                            return (
                                <Link
                                    key={galaxy.name}
                                    href={`/universe?galaxy=${galaxy.id}`}
                                >
                                    <motion.div
                                        initial={{ opacity: 0, y: 50 }}
                                        whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <div className="flex flex-col items-center justify-between gap-6 sm:flex-row">
                        <div className="flex flex-col items-center sm:items-end gap-2">
                            <p className="text-sm text-white/50">
                                Data provided by NASA Open Datasets
                            </p>
                            <p className="text-sm text-white/60 font-medium">
                                © 2025 Team CosmonovaBD. All rights reserved.
                            </p>
                        </div>
                    </div>
                </div>
